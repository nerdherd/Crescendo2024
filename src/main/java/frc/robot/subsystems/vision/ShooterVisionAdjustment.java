...
public class ShooterVisionAdjustment implements Reportable{
    ...
    private double[] distances = {1.33, 2.82, 3.5, 4.00}; // meters, from least to greatest
    private double[] angles = {ShooterConstants.kSpeakerPosition.get(), ShooterConstants.kSpeakerPosition2.get(), -21.5, -20}; // rotations // TODO: Convert to degrees
