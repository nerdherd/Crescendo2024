...
import frc.robot.commands.TowSwerve;
...
public class RobotContainer {
  ...
  private void initNamedCommands() {
    NamedCommands.registerCommand("IntakeDirectShoot", superSystem.intakeDirectShoot());
    NamedCommands.registerCommand("Wait1Sec", new WaitCommand(1));
    NamedCommands.registerCommand("TowSwerve", new TowSwerve(swerveDrive));
  }
  ...
  private void initAutoChoosers() {
    ...
    // if (paths.contains("Basic4PieceNamedCommand")) {
    //   autoChooser.addOption("Basic4NamedCommand", (AutoBuilder.followPath(null)PathPlannerAuto.getPathGroupFromAutoFile("Basic4PieceNamedCommand")));
    // }
