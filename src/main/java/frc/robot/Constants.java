...
public final class Constants {
  ...
  public static final class ShooterConstants {
    ...
    public static final PrefDouble kTopOuttakeLow   = new PrefDouble("Top Shooter Outtake Low", 30);
    public static final PrefDouble kTopOuttakeLowAutostart   = new PrefDouble("Top Shooter Outtake Low", 50);
    ...
    public static final PrefDouble kSpeakerPositionAutoStart  = new PrefDouble("Pivot Speaker Position Auto", -38);
    public static final PrefDouble kSpeakerPositionAutoStart2  = new PrefDouble("Pivot Speaker Position Auto", -30);
