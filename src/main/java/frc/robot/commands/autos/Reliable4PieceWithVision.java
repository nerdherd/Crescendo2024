    ...
    public Reliable4PieceWithVision(SwerveDrivetrain swerve, String autoPath, SuperSystem superSystem, DriverAssist driverAssist) {     
        ...
        addCommands(
            ...
            Commands.sequence(
                ...
                driverAssist.resetOdoPoseWithConversion(swerve, startingPose, 4, true), //change april tag id ltr
                Commands.deadline(
                ...
                // Piece 3
                driverAssist.resetOdoPoseWithConversion(swerve, startingPose, 7, true), 
                Commands.deadline(
