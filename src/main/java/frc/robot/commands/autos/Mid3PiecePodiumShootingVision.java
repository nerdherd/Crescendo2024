...
public class Mid3PiecePodiumShootingVision extends SequentialCommandGroup {
    public Mid3PiecePodiumShootingVision(SwerveDrivetrain swerve, String autoPath, SuperSystem superSystem, DriverAssist driverAssist, ShooterVisionAdjustment sva) {     
